        ...
        if (stepLearning == 0)
            {
                ...
                instructionTxt.text = "Use the <color=#ffa500ff>left joystick</color> to change the <color=#ffa500ff>speed</color>";
                ...
                joyStickR.transform.GetChild(0).gameObject.SetActive(true);
                joyStickR.transform.GetChild(1).gameObject.SetActive(true);
                joyStickR.transform.GetChild(2).gameObject.SetActive(false);
                joyStickR.transform.GetChild(3).gameObject.SetActive(false);


            if (Input.GetAxis("Throttle_manette") != 0 && stop)
                {
            ...
            {
                instructionTxt.enabled = true;
                instructionTxt.text = "Now try follow the circle";
                StartCoroutine(waitBeforeStep(1f));
            }

            if (stepLearning == 4 && stop)
            {
                instructionTxt.text = "<size=60>You can use lower to pass the next hoops</size>";
                StartCoroutine(waitBeforeStep(1f));
            }
